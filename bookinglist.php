...
<body>
  ...
  <tr>
    ...
    <td><?php echo $info["cc_center"];?></td>
    <td><?php echo $info["f_package"];?></td>
    <td><?php echo $info["s_date"];?></td>
    <td><?php echo $info["requirement"];?></td>
    <td>
        <input type="submit" name="submit" id="submit" class="btn btn-Red" value="Accept">
    </td>
    <td>
        <input type="submit" name="submit" id="submit" class="btn btn-Red" value="Reject">
    </td>
  </tr>
  <?php
  }
